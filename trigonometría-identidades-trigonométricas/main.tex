...
% El paquete "graphbox" nos permite alinear una imagen que es mostrada
% en una oración verticalmente con el contenido de la oración. Si no
% usamos "graphbox", el texto de un párrafo sera alineado con la parte
% más baja de la imagen en una línea.
\usepackage{graphbox}

\usepackage{titlesec}
\titleformat{\section}  % which section command to format
  {\fontsize{20}{20}\bfseries\color{blue}} % format for whole line
...
\titleformat{\subsection}
  {\fontsize{18}{18}\bfseries\color{blue}} % format for whole line
...
% Fuente usada en el encabezado y pie de página
\setkomafont{pageheadfoot}{\normalfont}
% Contenido a la izquierda en el encabezado
\ihead{\fontsize{30pt}{36pt}\selectfont \bfseries Identidades trigonométricas}
% Contenido a la derecha en el encabezado
\ohead{}
% Contenido a la izquierda en el pie de página
\ifoot{\fontsize{20pt}{30pt}\selectfont Descarga otros posters, contribuye y obtén el código fuente de este poster en: \includegraphics[height=35pt,vshift=-18pt]{../qr.png}}
...
\newcommand\myheading[1]{{\color{blue}#1}}
% LaTeX deefine la función seno como \sin, con el siguiente comando,
% podemos usar el comando \sen
...
\myheading{Identidades de las razones trigonométricas recíprocas}

\begin{itemize}
    \item $\sen\left(x\right) \cdot \csc\left(x\right) \myequal 1 \myrightarrow \csc\left(x\right) = \dfrac{1}{\sen\left(x\right)}$
...
\myheading{Identidades por división o por cociente}

\begin{itemize}
    \item $\tan\left(x\right) \myequal \dfrac{\sen\left(x\right)}{\cos\left(x\right)}$
    \item $\cot\left(x\right) \myequal \dfrac{\cos\left(x\right)}{\sen\left(x\right)}$
\end{itemize}

\myheading{Identidades pitagóricas}

\begin{itemize}
    \item $\sen^2\left(x\right) + \cos^2\left(x\right) \myequal 1$
    \item $\sec^2\left(x\right) \myequal 1 + \tan^2\left(x\right)$
    \item $\csc^2\left(x\right) \myequal 1 + \cot^2\left(x\right)$
\end{itemize}

\myheading{Identidades auxiliares}

\begin{itemize}
    \item $\left( \sen\left(x\right) \pm \cos\left(x\right) \right)^2 \myequal 1 \pm 2 \sen\left(x\right) \cos\left(x\right)$
    \item $\sen^4\left(x\right) + \cos^4\left(x\right) \myequal 1 - 2 \sen^2\left(x\right) \cos^2\left(x\right)$
    \item $\sen^6\left(x\right) + \cos^6\left(x\right) \myequal 1 - 3 \sen^2\left(x\right) \cos^2\left(x\right)$
    ...
    \item $\left( 1 \pm \sen\left(x\right) \pm \cos\left(x\right) \right)^2 \myequal 2 \left(1 \pm \sen\left(x\right)\right) \left(1 \pm \cos\left(x\right)\right)$
    ...
    \item $a \cdot \sen\left(x\right) + b \cos\left(x\right) = \sqrt{a^2 + b^2} \\ \myrightarrow  \sen\left(x\right) \myequal \dfrac{a}{\sqrt{a^2 + b^2}} \myland \cos\left(x\right) \myequal \dfrac{b}{\sqrt{a^2 + b^2}}$
    \item $\dfrac{\cos\left(x\right)}{1 \pm \sen\left(x\right)} \myequal \dfrac{1\mp\sen\left(x\right)}{\cos\left(x\right)}$
    \item $\dfrac{\sen\left(x\right)}{1 \pm \cos\left(x\right)} \myequal \dfrac{1\mp\cos\left(x\right)}{\sen\left(x\right)}$
\end{itemize}

\myheading{Desigualdades}

\begin{itemize}
    \item $\forall x \in \mathbb{R} , n \in \mathbb{Z}^{+} \colon \dfrac{1}{2^{n-1}} \leq \sen^{2n} \left(x\right) + \cos^{2n} \left(x\right) \leq 1$
    \item $\forall x, a, b\in \mathbb{R} \colon - \sqrt{a^2 + b^2} \leq a \cdot \sen\left(x\right) + b \cdot \cos\left(x\right) \leq \sqrt{a^2 + b^2}$
...
\myheading{Identidades de la suma y diferencia de dos ángulos}

\begin{itemize}
    \item $\sen \left(x \pm y\right) \myequal \sen\left(x\right) \cos\left(y\right) \pm \cos\left(x\right) \sen\left(y\right)$
    \item $\cos \left(x \pm y\right) \myequal \cos\left(x\right) \cos\left(y\right) \mp \sen\left(x\right) \sen\left(y\right)$
    \item $\tan \left(x \pm y\right) \myequal \dfrac{\tan\left(x\right)\pm \tan\left(y\right)}{1 \mp \tan\left(x\right) \tan\left(y\right)}$
\end{itemize}

\myheading{Identidades auxiliares de la suma y diferencia de dos ángulos}

\begin{itemize}
     \item $\sen\left(x + y\right) \cdot \sen\left(x - y\right) \myequal \sen^2\left(x\right) - \sen^2\left(y\right)$
     \item $\cos\left(x + y\right) \cdot \cos\left(x - y\right) \myequal \cos^2\left(x\right) - \sen^2\left(y\right)$
     \item $\tan\left(\theta\right) \myequal \dfrac{b}{a} \myleftrightarrow a \cdot \sen\left(x\right) \pm b \cdot \cos\left(x\right) \myequal \sqrt{a^2 + b^2} \cdot \sen\left(x \pm \theta\right)$
...
\begin{itemize}
    \item $\sen\left(2x\right) \myequal 2 \sen\left(x\right) \cos\left(x\right)$
    \item $\cos\left(2x\right) \myequal \cos^2\left(x\right) - \sen^2\left(x\right)$
    \item $\tan\left(2x\right) \myequal \dfrac{2 \tan\left(x\right)}{1 - \tan^2\left(x\right)}$
    \item $\sen\left(2x\right) \myequal \dfrac{2 \tan\left(x\right)}{1 + \tan^2\left(x\right)}$
    \item $\cos\left(2x\right) \myequal \dfrac{1 - \tan^2\left(x\right)}{1 + \tan^2\left(x\right)}$
    \item $\cos\left(2x\right) \myequal 1 - 2 \sen^2\left(x\right) $
    \item $\cos\left(2x\right) \myequal 2 \cos^2\left(x\right) - 1$
\end{itemize}

\myheading{Identidades de degradación}

\begin{itemize}
    \item $2 \sen^2\left(x\right) \myequal 1 - \cos\left(2x\right)$
    \item $2 \cos^2\left(x\right) \myequal 1 + \cos\left(2x\right)$
    \item $8 \sen^4\left(x\right) \myequal 3 - 4 \cos\left(2x\right) + \cos\left(4x\right)$
    \item $8 \cos^4\left(x\right) \myequal 3 + 4 \cos\left(2x\right) + \cos\left(4x\right)$
    \item $\sen^4\left(x\right) + \cos^4\left(x\right) \myequal \dfrac{3}{4} + \dfrac{1}{4} \cos\left(4x\right)$
    \item $\sen^6\left(x\right) + \cos^6\left(x\right) \myequal \dfrac{5}{8} + \dfrac{3}{8} \cos\left(4x\right)$
\end{itemize}

\myheading{Identidades auxiliares}

\begin{itemize}
    \item $\left(\sen\left(x\right) \pm \cos\left(x\right)\right)^2 \myequal 1 \pm \sen\left(2x\right)$
    \item $\sqrt{1 \pm \sen\left(2x\right)} \myequal \left|\sen\left(x\right) \pm \cos\left(x\right)\right|$
...
\begin{itemize}
    \item $\sen\left(\dfrac{x}{2}\right) \myequal \pm \sqrt{\dfrac{1 - \cos\left(x\right)}{2}}$
...
El signo de $\sen\left(\frac{x}{2}\right)$, $\cos\left(\frac{x}{2}\right)$ y $\tan\left(\frac{x}{2}\right)$ depende del cuadrante en el que se encuentra el lado final de $\frac{x}{2}$ y el signo de $\text{R.T.}\left(\frac{x}{2}\right)$ en ese cuadrante.
...
\begin{itemize}
    \item $\sen\left(3x\right) \myequal 3 \sen\left(x\right) - 4 \sen^3\left(x\right)$
...
\begin{itemize}
    \item $4\sen^3\left(x\right) \myequal 3 \sen\left(x\right) - \sen\left(3x\right)$
...
\begin{itemize}
    \item $\dfrac{\sen\left(3x\right)}{\sen\left(x\right)} \myequal 2 \cos\left(2x\right) + 1$
    ...
    \item $\sen\left(3x\right) \myequal 4 \sen\left(x\right) \sen\left(60\degree - x\right) \sen\left(60 \degree + x\right)$
...
\begin{itemize}
  \item $\sen\left(\alpha\right) + \sen\left(\beta\right) \myequal 2 \sen\left(\dfrac{\alpha + \beta}{2}\right) \cos\left(\dfrac{\alpha - \beta}{2}\right)$
\end{itemize}

Transformación de diferencia de senos a producto.

\begin{itemize}
  \item $\sen\left(\alpha\right) - \sen\left(\beta\right) \myequal 2 \cos\left(\dfrac{\alpha + \beta}{2}\right) \sen\left(\dfrac{\alpha - \beta}{2}\right)$
\end{itemize}
...
\begin{itemize}
  \item $\cos\left(\alpha\right) - \cos\left(\beta\right) \myequal - 2 \sen\left(\dfrac{\alpha + \beta}{2}\right) \sen\left(\dfrac{\alpha - \beta}{2}\right)$
\end{itemize}
...
\begin{itemize}
  \item $\sen\left(x\right) + \sen\left(y\right) + \sen\left(z\right) - \sen\left(x + y + z\right) \\ \myequal 4 \sen\left(\dfrac{x+y}{2}\right) \sen\left(\dfrac{y+z}{2}\right) \sen\left(\dfrac{x+z}{2}\right)$
...
\myheading{Identidades auxiliares condicionales}

Si $A + B + C = 180\degree$, entonces

\begin{itemize}
  \item $\sen\left(A\right) + \sen\left(B\right) + \sen\left(C\right) \\ \myequal 4 \cos\left(\dfrac{A}{2}\right) \cos\left(\dfrac{B}{2}\right) \cos\left(\dfrac{C}{2}\right)$
  \item $\cos\left(A\right) + \cos\left(B\right) + \cos\left(C\right) \\ \myequal 4 \sen\left(\dfrac{A}{2}\right) \sen\left(\dfrac{B}{2}\right) \sen\left(\dfrac{C}{2}\right) + 1$
  \item $\sen\left(2A\right) + \sen\left(2B\right) + \sen\left(2C\right) \\ \myequal 4 \sen\left(A\right) \sen\left(B\right) \sen\left(C\right)$
...
\begin{itemize}
  \item $2 \sen\left(x\right) \cos\left(y\right) \myequal \sen\left(x+y\right) + \sen\left(x-y\right)$
\end{itemize}
...
\begin{itemize}
  \item $2 \sen\left(x\right) \sen\left(y\right) \myequal \cos\left(x-y\right) - \cos\left(x + y\right)$
\end{itemize}
...
\begin{itemize}
  \item $\dfrac{\sen\left(3x\right)}{\sen\left(x\right)} \myequal 2 \cos\left(2x\right) + 1$
  \item $\dfrac{\sen\left(5x\right)}{\sen\left(x\right)} \myequal 2 \cos\left(4x\right) + 2 \cos\left(2x\right) + 1$
  \item $\dfrac{\sen\left(7x\right)}{\sen\left(x\right)} \myequal 2 \cos\left(6x\right) + 2 \cos\left(4x\right) + 2 \cos\left(2x\right) + 1$
\end{itemize}
...
\begin{itemize}
  \item $\displaystyle \sum_{k=1}^{n} \sen\left(x + kr\right) \myequal \dfrac{\sen\left(\dfrac{nr}{2}\right)}{\sen\left(\dfrac{r}{2}\right)} \cdot \sen\left(\dfrac{P+U}{2}\right)$
  \item $\displaystyle \sum_{k=1}^{n} \cos\left(x + kr\right) \myequal \dfrac{\sen\left(\dfrac{nr}{2}\right)}{\sen\left(\dfrac{r}{2}\right)} \cdot \cos\left(\dfrac{P+U}{2}\right)$
\end{itemize}
...
\begin{itemize}
  \item $\displaystyle \prod_{k=1}^{n} \sen \left(\dfrac{k \pi}{2n + 1}\right) \myequal \dfrac{\sqrt{2n+1}}{2^n}$
