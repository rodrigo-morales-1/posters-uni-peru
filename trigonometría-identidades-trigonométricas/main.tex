...
El signo de $\sin\left(\frac{x}{2}\right)$, $\cos\left(\frac{x}{2}\right)$ y $\tan\left(\frac{x}{2}\right)$ depende del cuadrante en el que se encuentra el lado final de $\frac{x}{2}$ y el signo de $\text{R.T.}\left(\frac{x}{2}\right)$ en ese cuadrante.
