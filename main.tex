...
\newcommand\myequal{\mathrel{\mybox{$=$}}}
...
\begin{itemize}
    \item $\tan\left(x\right) = \dfrac{\sin\left(x\right)}{\cos\left(x\right)}$
    \item $\cot\left(x\right) = \dfrac{\cos\left(x\right)}{\sin\left(x\right)}$
\end{itemize}
...
\begin{itemize}
    ...
    \item $\sec^2\left(x\right) + \tan^2\left(x\right) = 1$
    \item $\csc^2\left(x\right) + \cot^2\left(x\right) = 1$
\end{itemize}

Identidades auxiliares

\begin{itemize}
\item $\left( \sin\left(x\right) \pm \cos\left(x\right) \right)^2 = 1 \pm 2 \sin\left(x\right) \cos\left(x\right)$
\item $\sin^4\left(x\right) + \cos^4\left(x\right) = 1 - 2 \sin^2\left(x\right) \cos^2\left(x\right)$
\item $\sin^6\left(x\right) + \cos^6\left(x\right) = 1 - 3 \sin^2\left(x\right) \cos^2\left(x\right)$
\item $\tan\left(x\right) + \cot\left(x\right) = \sec\left(x\right) \csc\left(x\right)$
\item $\sec^2 \left(x\right) + \csc^2 \left(x\right) = \sec^2\left(x\right) \csc^2 \left(x\right)$
\item $\sec\left(x\right) + \tan\left(x\right) = m \rightarrow \sec\left(x\right) - \tan\left(x\right) = \dfrac{1}{m}$
\item $\csc\left(x\right) + \cot\left(x\right) = m \rightarrow \csc\left(x\right) - \cot\left(x\right) = \dfrac{1}{m}$
\item $\left( 1 + \pm \sin\left(x\right) \pm \cos\left(x\right) \right)^2 = 2 \left(1 \pm \sin\left(x\right)\right) \left(1 \pm \cos\left(x\right)\right)$
\item $a \cdot \sin\left(x\right) + b \cos\left(x\right) = c \land c = \sqrt{a^2 + b^2} \rightarrow \sin\left(x\right) = \dfrac{a}{c} \land \cos\left(x\right) = \dfrac{b}{c}$
\end{itemize}
...
\begin{itemize}
    \item $\tan\left(x\right) + \tan\left(y\right) + \tan\left(z\right) = \tan\left(x\right) \tan\left(y\right) \tan\left(z\right)$
    \item $\cot\left(x\right) \cot\left(y\right) + \cot\left(y\right) \cot\left(z\right) + \cot\left(z\right) \cot\left(x\right) = 1$
\end{itemize}

Si $\exists k \in \mathbb{Z} \colon x + y + z = \displaystyle \frac{\left(2k+1\right) \pi}{2}$, entonces:

\begin{equation*}
    \begin{aligned}
        \cot\left(x\right) + \cot\left(y\right) + \cot\left(z\right) &= \cot\left(x\right) \cot\left(y\right) \cot\left(z\right)
...
\begin{equation*}
    \begin{aligned}
        ...
        \tan\left(2x\right) \cdot \cot\left(x\right) &= \sec\left(2x\right) + 1 \\
        \tan\left(2x\right) \cdot \tan\left(x\right) &= \sec\left(2x\right) - 1
    \end{aligned}
\end{equation*}
...
\begin{equation*}
    \begin{aligned}
        \sin\left(3x\right) &= \sin\left(x\right) \left(2 \cos\left(2x\right) + 1\right) \\
        \cos\left(3x\right) &= \cos\left(x\right) \left(2 \cos\left(2x\right) - 1\right) \\
        \tan\left(3x\right) &= \tan\left(x\right) \left( \frac{2 \cos\left(2x\right) + 1}{2 \cos\left(2x\right) - 1}\right)
    \end{aligned}
\end{equation*}

\begin{equation*}
    \begin{aligned}
        \sin\left(3x\right) &= 4 \sin\left(x\right) \sin\left(60\degree - x\right) \sin\left(60 \degree + x\right) \\
        \cos\left(3x\right) &= 4 \cos\left(x\right) \cos\left(60\degree - x\right) \cos\left(60 \degree + x\right) \\
        \tan\left(3x\right) &= 4 \tan\left(x\right) \tan\left(60\degree - x\right) \tan\left(60 \degree + x\right)
    \end{aligned}
\end{equation*}
