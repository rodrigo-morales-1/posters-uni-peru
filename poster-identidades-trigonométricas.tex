...
\begin{itemize}
    ...
    \item $a \cdot \sin\left(x\right) + b \cos\left(x\right) = c \land c = \sqrt{a^2 + b^2} \\ \myrightarrow  \sin\left(x\right) \myequal \dfrac{a}{c} \land \cos\left(x\right) \myequal \dfrac{b}{c}$
\end{itemize}
