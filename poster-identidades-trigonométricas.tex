...
$\sin\left(\alpha\right) + \sin\left(\beta\right) \myequal 2 \sin\left(\dfrac{\alpha + \beta}{2}\right) \cos\left(\dfrac{\alpha - \beta}{2}\right)$

Transformación de diferencia de senos a producto.

$\sin\left(\alpha\right) - \sin\left(\beta\right) \myequal 2 \cos\left(\dfrac{\alpha + \beta}{2}\right) \sin\left(\dfrac{\alpha - \beta}{2}\right)$

Transformación de suma de cosenos a producto.

$\cos\left(\alpha\right) + \cos\left(\beta\right) \myequal 2 \cos\left(\dfrac{\alpha + \beta}{2}\right) \cos\left(\dfrac{\alpha - \beta}{2}\right)$

Transformación de diferencia de cosenos a producto.

$\cos\left(\alpha\right) - \cos\left(\beta\right) \myequal - 2 \sin\left(\dfrac{\alpha + \beta}{2}\right) \sin\left(\dfrac{\alpha - \beta}{2}\right)$
...
\subsection{Identidades de transformación de un producto de senos y/o cosenos hacia suma o diferencia}

Transformación de un producto de senos hacia suma.

$2 \sin\left(x\right) \cos\left(y\right) \myequal \sin\left(x+y\right) + \sin\left(x-y\right)$

Transformación de un producto de cosenos hacia suma.

$2 \cos\left(x\right) \cos\left(y\right) \myequal \cos\left(x+y\right) + \cos\left(x-y\right)$

Transformación de un producto de senos hacia diferencia de cosenos.

$2 \sin\left(x\right) \sin\left(y\right) \myequal \cos\left(x-y\right) - \cos\left(x + y\right)$

\subsection{Identidades de transformación de cociente a suma o diferencia de cosenos}

Identidades de transformación de cociente del seno

\begin{itemize}
  \item $\dfrac{\sin\left(3x\right)}{\sin\left(x\right)} = 2 \cos\left(2x\right) + 1$
  \item $\dfrac{\sin\left(5x\right)}{\sin\left(x\right)} = 2 \cos\left(4x\right) + 2 \cos\left(2x\right) + 1$
  \item $\dfrac{\sin\left(7x\right)}{\sin\left(x\right)} = 2 \cos\left(6x\right) + 2 \cos\left(4x\right) + 2 \cos\left(2x\right) + 1$
\end{itemize}

Identidades de transformación de cociente del coseno

\begin{itemize}
  \item $\dfrac{\cos\left(3x\right)}{\cos\left(x\right)} = 2 \cos\left(2x\right) - 1$
  \item $\dfrac{\cos\left(5x\right)}{\cos\left(x\right)} = 2 \cos\left(4x\right) - 2 \cos\left(2x\right) + 1$
  \item $\dfrac{\cos\left(7x\right)}{\cos\left(x\right)} = 2 \cos\left(6x\right) - 2 \cos\left(4x\right) + 2 \cos\left(2x\right) - 1$
\end{itemize}
