...
\begin{itemize}
    ...
    \item $\sec\left(x\right) + \tan\left(x\right) \myequal m \myrightarrow \sec\left(x\right) - \tan\left(x\right) \myequal \dfrac{1}{m}$
    \item $\csc\left(x\right) + \cot\left(x\right) \myequal m \myrightarrow \csc\left(x\right) - \cot\left(x\right) \myequal \dfrac{1}{m}$
    ...
    \item $a \cdot \sin\left(x\right) + b \cos\left(x\right) = c \myland c = \sqrt{a^2 + b^2} \\ \myrightarrow  \sin\left(x\right) \myequal \dfrac{a}{c} \myland \cos\left(x\right) \myequal \dfrac{b}{c}$
\end{itemize}
