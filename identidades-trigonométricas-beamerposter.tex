...
\usepackage{multicol}
\usepackage{tikz}
% El paquete "amssymb" añade el macro \mathbb{...}
\usepackage{amssymb}
% El paquete "gensymb" añade el macro "\degree"
\usepackage{gensymb}
...
\renewcommand{\section}[1]{%
    ...
    {%
        ...
        % Calculate the width of the number + space
        \settowidth{\hangindent}{\thesection\quad}%
        \hangafter=1 % Apply hang after the first line
        \thesection\quad #1\par
    }
...
\renewcommand{\subsection}[1]{%
   \stepcounter{subsection}
    {%
        ...
        % Calculate the width of the number + space
        \settowidth{\hangindent}{\thesection.\thesubsection\quad}%
        \hangafter=1 % Apply hang after the first line
        \thesection.\thesubsection\quad #1\par
    }
