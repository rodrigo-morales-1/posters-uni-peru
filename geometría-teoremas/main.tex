...
\begin{multicols*}{3}
    ...
    \begin{minipage}{\linewidth}
        \begin{center}
            ...
            Si $BH = NP$, entonces:
            \myFormula{$\dfrac{\myPolygonArea{ABC}}{\myPolygonArea{MNL}} = \dfrac{b}{n}$}
        \end{center}
    \end{minipage}
    \begin{minipage}{0.5\linewidth}
        \begin{center}
            ...
            Si $\overline{BM}$ es mediana, entonces:
            \myFormula{$\myPolygonArea{ABM} = \myPolygonArea{MBC}$}
        \end{center}
    \end{minipage}
    \begin{minipage}{0.5\linewidth}
        \begin{center}
